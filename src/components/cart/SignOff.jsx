...
<section className="mt-6 text-[10px] leading-tight">
  ...
  <div className="flex flex-col gap-1" >
    <input type="text" className="w-[180px]  h-4 bg-gray-200/60 px-2 py-1 m-0"
          onChange={(e)=> handleCustomerDetailsOnchange('qinfo', 'prepby', e.target.value)}
          defaultValue = {quoteDetails.qinfo?.prepby}
          placeholder="Name"
    />
    <input type="text" className="w-[180px]  h-4 bg-gray-200/60 px-2 py-1"
...
<section className="mt-6 grid grid-cols-2 gap-6 text-[10px]">
  ...
  <div className="space-y-[2px]">
    <input
      ...
      className="w-full bg-gray-200/60 px-2 py-1 outline-none h-4"
    ...
    <input
      ...
      className="w-full px-2 py-1 outline-none h-4"
